...
The final report is available as `E-commerce_business_report.html` in the project root.
...
├─ E-commerce_business_report.html       # Rendered HTML report
...
```bash
quarto render .\scripts\E-commerce_business_report.ipynb --to html
```
...
- Write/update `E-commerce_business_report.html` in the project root
...
5. Install Quarto and render the report: `quarto render .\scripts\E-commerce_business_report.ipynb --to html`.
